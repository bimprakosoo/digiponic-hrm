					...
					<div class="container-sm">
						<div class="hero-inner section-inner">
							...
							>
								<img
									class="has-shadow"
									src="<?php echo base_url();?>/assets/images/hero-image.png"
									alt="Hero image"
									width="896"
									height="504"
								/>
					...
					<div class="container">
						...
						>
							<ul class="list-reset">
								<li>
									<img
										src="<?php echo base_url();?>/assets/images/clients-01.svg"
										alt="Clients 01"
									/>
								</li>
								<li>
									<img
										src="<?php echo base_url();?>/assets/images/clients-02.svg"
										alt="Clients 02"
									/>
								</li>
								<li>
									<img
										src="<?php echo base_url();?>/assets/images/clients-03.svg"
										alt="Clients 03"
									/>
								</li>
								<li>
									<img
										src="<?php echo base_url();?>/assets/images/clients-04.svg"
										alt="Clients 04"
									/>
								</li>
								<li>
									<img
										src="<?php echo base_url();?>/assets/images/clients-05.svg"
										alt="Clients 05"
									/>
								</li>
							</ul>
								...
								<div class="tiles-item reveal-from-bottom">
									<div class="tiles-item-inner">
										<div class="features-tiles-item-header">
											...
											>
												<img
													src="<?php echo base_url();?>/assets/images/feature-tile-icon-01.svg"
								...
								>
									<div class="tiles-item-inner">
										<div class="features-tiles-item-header">
											...
											>
												<img
													src="<?php echo base_url();?>/assets/images/feature-tile-icon-02.svg"
								...
								>
									<div class="tiles-item-inner">
										<div class="features-tiles-item-header">
											...
											>
												<img
													src="<?php echo base_url();?>/assets/images/feature-tile-icon-03.svg"
