                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8">
                            <div class="card" style="background: #FFFFFF;box-shadow: 0px 4px 44px rgba(0, 0, 0, 0.15);border-radius: 5px;">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        <h5 class="col-sm-2 text-sm-left"><strong>Indikator</strong></h5>
                                        <div class="col-sm-6 ml-auto">
                                            <h5><strong>Tetapkan Nilai</strong></h5>
                                        </div>
                                    </div>
                                    <form>
                                        <h5 class="col-sm-2 text-sm-left"><strong>1. Kedisiplinan</strong></h5>
                                        <div class="mb-3 row">
                                        ...
                                        <h5 class="col-sm-4 text-sm-left"><strong>3. Kompetensi Umum</strong></h5>
                                        <div class="mb-3 row">
